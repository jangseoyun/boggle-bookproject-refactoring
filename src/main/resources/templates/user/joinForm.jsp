		...
		<div class="container">
			<div id="join-content" class="row">
				<form action="${pageContext.request.contextPath}/user/join" method="get">
					...
					<div>닉네임(1~6자)*</div>
					<div class="except">
						<input type="text" maxlength='6' id="nickname" name="nickname" placeholder="닉네임을 입력해주세요" oninput="checknickname()">
						<!--닉네임이 사용중일경우-->
                        <p class="nickname_already">이미 사용중인 닉네임입니다.</p>
					</div>
					<div>이메일주소*</div>
					<div class="except">
						<input type="text" id="email" name="email" placeholder="ID@example.com" oninput="checkemail()">
						<!--메일주소가 사용중일경우-->
